...
var map = new ol.Map({
    ...
    view: new ol.View({
        ...
        maxZoom: 23,
        minZoom: 8,
        extent: [911066.806447, 6232703.337984, 914347.639781, 6234403.021317],
        projection: new ol.proj.Projection({
            code: 'EPSG:2154',
            //extent: [911830.640207, 6232805.531020, 913029.827087, 6234258.562226],
            units: 'm'
        })
    })
});
...
map.getView().fit([911066.806447, 6232703.337984, 914347.639781, 6234403.021317], map.getSize());
